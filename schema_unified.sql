...
-- CRITICAL: Must have bus_route_id column for C++ client compatibility
-- ========================================================
...
-- ========================================================
-- SEED DATA - Routes (Comprehensive Network)
-- All major cities with bidirectional routes
-- ========================================================
INSERT INTO routes (origin, destination, distance_km) VALUES 
-- Primary Manila connections (bidirectional)
('Manila', 'Tabaco', '450.50'),
('Tabaco', 'Manila', '450.50'),
('Manila', 'Legazpi', '400.00'),
('Legazpi', 'Manila', '400.00'),
('Manila', 'Daet', '350.00'),
('Daet', 'Manila', '350.00'),
('Manila', 'Naga', '380.00'),
('Naga', 'Manila', '380.00'),
-- Additional routes for expanded coverage
('Manila', 'Camalig', '420.00'),
('Camalig', 'Manila', '420.00'),
('Tabaco', 'Legazpi', '55.00'),
('Legazpi', 'Tabaco', '55.00'),
('Legazpi', 'Naga', '65.00'),
('Naga', 'Legazpi', '65.00'),
('Daet', 'Naga', '45.00'),
('Naga', 'Daet', '45.00'),
...
-- Note: Passwords stored as shown for demonstration
...
-- ========================================================
-- SEED DATA - Bus-Route Assignments
-- All buses assigned to routes for comprehensive coverage
-- ========================================================
...
-- Routes 9-10: Manila-Camalig & Camalig-Manila
...
-- Routes 11-12: Tabaco-Legazpi & Legazpi-Tabaco
...
-- Routes 13-14: Legazpi-Naga & Naga-Legazpi
...
-- Routes 15-16: Daet-Naga & Naga-Daet
...
-- Routes 17-18: Tabaco-Naga & Naga-Tabaco
...
-- ========================================================
-- SEED DATA - Test Schedules
-- Comprehensive coverage for all routes
-- ========================================================
INSERT INTO schedules (bus_route_id, departure_time, arrival_time, fare) VALUES 
-- Manila to Tabaco routes
...
--    WHERE table_schema = 'transit_system' OR table_schema = 'b33_41637866_TRANSITGO'
--    ORDER BY table_name;
--
...
--    UNION ALL SELECT 'bus_routes', COUNT(*) FROM bus_routes
--    UNION ALL SELECT 'schedules', COUNT(*) FROM schedules
--    UNION ALL SELECT 'passengers', COUNT(*) FROM passengers
--    UNION ALL SELECT 'tickets', COUNT(*) FROM tickets;
--
-- 3. Test schedule query with joins:
--    SELECT s.id, s.departure_time, b.bus_number, r.origin, r.destination, s.fare
--    FROM schedules s
...
--    LIMIT 5;
--
-- 4. Verify passenger bookings:
--    SELECT t.id, p.name, p.email, r.origin, r.destination, t.seat_number, t.trip_code
--    FROM tickets t
...
-- ✅ PHP Web Portal (Admin Dashboard + Passenger Portal)
-- ✅ C++ Transit Client (Desktop Application)
-- 
-- Key Requirements Met:
-- ✅ bus_routes junction table for M:N relationships
-- ✅ bus_route_id in schedules table (required for C++ client)
-- ✅ Comprehensive route network (18 routes for testing)
-- ✅ Multiple bus types for client selection
